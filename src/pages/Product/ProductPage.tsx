      ...
      <div className="product-page-container">
        ...
        <div className="product-details">
          ...
          <div className="product-offers">
            <div className="offer-tag">BUY 2 FOR $50, USE CODE: DOUBLE</div>
            <div className="offer-tag">FLAT 20% OFF ON CARDS</div>
          </div>
          ...
          <div className="product-accordion">
            ...
            >
              ...
              <ChevronDown className={`chevron ${isAccordionOpen ? 'open' : ''}`} size={20} />
            </div>
            {isAccordionOpen && (
